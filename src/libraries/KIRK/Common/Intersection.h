...
namespace KIRK {
	...
	public:
		...
		*/
		void update(Object *obj, const float lambda, const bool enter);
		...
		*/
		void update(Object *obj, const float lambda, const bool enter, const glm::vec3 bcc);

		// public attributes
		Ray m_ray; ///< the Ray object which intersects with.
		float m_lambda; ///<distance from ray origin to intersection
		Object* m_object; ///<pointer to the object that is intersected YOU NEED TO ENSURE THE LIFETIME OF THE OBJECT EXEEDS THE LIFETIME OF THE INTERSECTION
