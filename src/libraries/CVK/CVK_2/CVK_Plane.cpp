...
CVK::Plane::Plane(glm::vec3 a, glm::vec3 b, glm::vec3 c, glm::vec3 d)
{
    create(a, b, c, d, glm::vec2(0, 1), glm::vec2(0, 0), glm::vec2(1, 0), glm::vec2(1, 1));
    m_geotype = CVK_PLANE;
}

CVK::Plane::Plane(glm::vec3 a, glm::vec3 b, glm::vec3 c, glm::vec3 d, glm::vec2 tca, glm::vec2 tcb, glm::vec2 tcc,
                  glm::vec2 tcd)
{
...
void CVK::Plane::create(glm::vec3 a, glm::vec3 b, glm::vec3 c, glm::vec3 d, glm::vec2 tca, glm::vec2 tcb, glm::vec2 tcc,
                        glm::vec2 tcd)
{
